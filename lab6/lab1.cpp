...
int main()
{
    ...
    do {
        ...
        std::puts("16. Stworz pajeczaki");
        std::puts("17. Pobierz dane do pliku");
        std::puts("18. U¿yj operatora []");
        std::puts("19. U¿yj operatora przypisania");
        std::puts("0. Wyjdz");
        ...
        case 16:
            do {
                ...
                Cmucha* ogrod[5];
                ogrod[0] = new Pajeczak(150, "Cmucha1", "Nazwisko1", "Gatunek1");
                ogrod[1] = new Pajeczak(200, "Cmucha2", "Nazwisko2", "Gatunek2");
                ogrod[2] = new Pajeczak(180, "Cmucha3", "Nazwisko3", "Gatunek3");
                ogrod[3] = new Pajeczak(160, "Cmucha4", "Nazwisko4", "Gatunek4");
                ogrod[4] = new Mucholapka(190, "Cmucha5", "Nazwisko5", 1000);

                for (Cmucha* pajeczak : ogrod) {
                    pajeczak->print();
                    std::cout << "------------------" << std::endl;
                }

                Ogrod& ogr = Cmucha::getOgrod();
                std::cout << ogr.get() << std::endl;
        ...
        case 19:
            do {
                // pokazanie portu p2 przed przypisaniem
                p2.print();
                p2 = p1;
                p2.print();
                std::puts("0. EXIT");
